...
import 'dart:math';
import 'package:news_views/Model/News_Model.dart';
...
class _NewsCardState extends State<NewsCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.isFront
        ? buildFrontCard(distance, blur)
        : buildCard(distance, blur);
  }

  Widget buildCard(Offset distance, double blur) => AnimatedContainer(
